...
graph TD
    ...
    subgraph P1 ["Phase 1: Preparation & Detection"]
        ...
        Events -->|Security Observations| Signals["Signals<br>(Informational Observation)"]
    ...
    subgraph P2 ["Phase 2: Detection & Analysis"]
        ...
        subgraph P22 ["Phase 2.b: Investigation"]
            G2 -->|Promote to Investigation| Investigate[IC Playbook<br>Concurrent Malicious/Benign hypothesis testing]
    ...
    subgraph Metrics ["05-Metrics"]
        Gates[Operational Metrics<br>Speed: MTTD / MTTI / MTTC / MTTR<br>Quality: precision and recall per gate<br>Cost: Token Economics]
    end
...
5. **[05-Metrics](05-Metrics/operational_metrics.md)**: Process-anchored speed metrics (MTTD, MTTI, MTTC, MTTR, HITL Dwell Time), disposition quality as precision and recall per gate (Disposition Mix, Triage Precision, Verdict Precision, Observed Verdict Recall), paired autonomy-quality metrics, and Token Economics (compute/LLM pricing).
...
graph TD
    ...
    P2 -->|Triage uses| PB2
    P2 -->|Investigation executes Malicious/Benign| PB3
...
The ZeroSOC Framework is licensed under the **[Apache License 2.0](LICENSE)** (see also [NOTICE](NOTICE) and [Design Decisions](01-Foundation/design_decisions.md)).
