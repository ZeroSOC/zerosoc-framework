...
- **Per-Playbook Efficacy Metrics:** per-playbook MTTC/MTTR, verdict misses found at QA sampling, and HITL-modification rate — a natural feeder for the **Metrics & Maturity (P1)** objective once that work matures.
