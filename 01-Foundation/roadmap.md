...
- **Machine-Readable Integration Contract:** JSON Schemas freezing playbook frontmatter, the [§5 Handoff Contract](../04-Playbooks/playbook_architecture.md), and Triage/Investigation Note structures — versioning the "markdown-as-interface" promise under explicit control.
